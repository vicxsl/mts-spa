...
public class AdminResponseBodyAdviceChain implements ResponseBodyAdvice<BaseResponse> {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(AdminResponseBodyAdviceChain.class);
